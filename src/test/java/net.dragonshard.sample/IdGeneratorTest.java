...
public class IdGeneratorTest {
    ...
    public void testLocalIdGenerator() throws Exception {
        ...
        Assert.assertNotNull(localIdGenerator.nextUniqueId(Long.parseLong(dataCenter), Long.parseLong(machine)), null);
        Assert.assertEquals(localIdGenerator.nextUniqueIds(5).length, 5);
        Assert.assertEquals(localIdGenerator.nextUniqueIds(Long.parseLong(dataCenter), Long.parseLong(machine), 7).length, 7);
    }
